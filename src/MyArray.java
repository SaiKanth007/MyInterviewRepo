...
public class MyArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The index of the search is: "
                        + binarySearchWithRepeatedElements(arrayForBinarySearchForRepeated, 0, arrayForBinarySearchForRepeated.length
                                        - 1, -1));
        ...
        System.out.println("Maximum value of contigious sub arrays is:"
                        + findLargetSumContiguousArray(maxSumContigiousArray));
    ...
    public static void heapSort(int[] input) {
        ...
        // this logic is basically for constructing the heap, takes O(n/2 * log(N) time complexity)
