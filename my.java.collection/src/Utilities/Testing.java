...
class Testing implements Serializable {
	...
	public static void testPriorityQueue() {
		PriorityQueue<Employee> pq = new PriorityQueue<Employee>((e1, e2) -> e1.getRank().compareTo(e2.getRank()));
		Employee e1 = new Employee("Jack", "A124", 23);
		Employee e2 = new Employee("Jack24", "A124", 24);
		pq.add(e2);
		pq.add(e1);
		...
		for (Map.Entry<Integer, Integer> emp : treeMap.entrySet()) {
